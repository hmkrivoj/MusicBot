...
/**
 * A {@link com.jagrosh.jdautilities.menu.Menu Menu} implementation that creates a organized display
 * of emotes/emojis as buttons paired with options, and below the menu reactions corresponding to
 * each button.
 *
 * @author John Grosh
 */
public class ButtonMenu extends Menu {
    ...
    ra.queue(
        m -> {
          for (int i = 0; i < choices.size(); i++) {
            ...
            RestAction<Void> r =
                emote == null ? m.addReaction(choices.get(i)) : m.addReaction(emote);
            if (i + 1 < choices.size())
   ...
   * com.jagrosh.jdautilities.menu.ButtonMenu ButtonMenu}.
   *
   * @author John Grosh
   */
  public static class Builder extends Menu.Builder<Builder, ButtonMenu> {
    ...
    /**
     * Sets the {@link java.util.function.Consumer Consumer} action to perform upon selecting a
     * button.
     *
     ...
     * com.jagrosh.jdautilities.menu.ButtonMenu ButtonMenu} is done, either via cancellation, a
     * timeout, or a selection being made.
     *
     * <p>This accepts the message used to display the menu when called.
     *
     ...
     *
     * <p>Any non-unicode {@link net.dv8tion.jda.api.entities.Emote Emote} should be added using
     * {@link ButtonMenu.Builder#addChoice(Emote) ButtonMenu.Builder#addChoice(Emote)}.
     *
     ...
     * ButtonMenu.Builder#addChoice(String) ButtonMenu.Builder#addChoice(String)}.
     *
     ...
     *
     * <p>Any non-unicode {@link net.dv8tion.jda.api.entities.Emote Emote}s should be added using
     * {@link ButtonMenu.Builder#addChoices(Emote...) ButtonMenu.Builder#addChoices(Emote...)}.
     *
     * @param emojis The String unicode emojis to add
     * @return This builder
     */
    public Builder addChoices(String... emojis) {
      for (String emoji : emojis) addChoice(emoji);
      return this;
    }
     ...
     * {@link ButtonMenu.Builder#setChoices(Emote...) ButtonMenu.Builder#setChoices(Emote...)}.
     *
