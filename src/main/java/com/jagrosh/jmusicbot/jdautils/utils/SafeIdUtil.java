...
public final class SafeIdUtil {
  /**
   * Safely convert the provided String ID to a {@code long} usable with {@link
   ...
   * @return If the String can be converted into a non-negative {@code long}, then it will return
   *     the conversion. <br>
