 ...
 */
package com.jagrosh.jmusicbot.jdautils.annotation;
 ...
 * {@link com.jagrosh.jmusicbot.jdautils.Command Command}s when added to a Client
 * using {@link com.jagrosh.jmusicbot.jdautils.CommandClientBuilder#addAnnotatedModule(Object)
 ...
 * com.jagrosh.jmusicbot.jdautils.AnnotatedModuleCompiler AnnotatedModuleCompiler}.
 * where they will be converted to Commands using {@link com.jagrosh.jmusicbot.jdautils.CommandBuilder
 * CommandBuilder}.
 *
 * <p>Classes that wish to be contain methods to be used as commands must be annotated with
 * {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Module @Module}.
 ...
 *
 * <pre><code>   {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Module @JDACommand.Module}({@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Module#value() value} = "example")
 * public class AnnotatedModuleCmd {
 *
 *     {@literal @JDACommand(}
 *          {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand#name() name} = {"example", "test", "demo"},
 *          {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand#help() help} = "gives an example of what commands do"
 *      )
 ...
 * }</code></pre>
 *
 * @see    com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Module
 *
 * @since  1.7
...
public @interface JDACommand
{
     ...
     * {@link com.jagrosh.jmusicbot.jdautils.Command#cooldown Command#cooldown}
     * and {@link com.jagrosh.jmusicbot.jdautils.Command#cooldownScope
     ...
     * {@link com.jagrosh.jmusicbot.jdautils.Command#usesTopicTags
     ...
     * this command's {@link com.jagrosh.jmusicbot.jdautils.Command.Category
     * Category}.
     *
     ...
     * into {@link com.jagrosh.jmusicbot.jdautils.Command Command}s.
     *
     * <p>Method names provided to this annotation must have one or two parameters.
     * Either a single parameter {@link com.jagrosh.jmusicbot.jdautils.CommandEvent
    ...
    @interface Module
    {
         ...
         * using the {@link com.jagrosh.jmusicbot.jdautils.AnnotatedModuleCompiler
    ...
    /**
     * A value wrapper for what would be {@link com.jagrosh.jmusicbot.jdautils.Command#cooldown
     * Command#cooldown} and {@link com.jagrosh.jmusicbot.jdautils.Command#cooldownScope
     * Command#cooldownScope}.
     *
     * The default {@link com.jagrosh.jmusicbot.jdautils.Command.CooldownScope CooldownScope}
     * is {@link com.jagrosh.jmusicbot.jdautils.Command.CooldownScope#USER CooldownScope.USER}.
     *
    ...
    @interface Cooldown
    {
         ...
         *
         * <p>By default this is {@link com.jagrosh.jmusicbot.jdautils.Command.CooldownScope#USER
         * CooldownScope.USER}.
         *
     ...
     * {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Category#location() location} using reflections, with a
     * matching {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Category#name() name}.
     *
     ...
     * {@link com.jagrosh.jmusicbot.jdautils.AnnotatedModuleCompiler compiler}.
     *
     * @see    com.jagrosh.jmusicbot.jdautils.annotation.JDACommand#category()
     */
    @Target(ElementType.TYPE)
    @Retention(RetentionPolicy.RUNTIME)
    @interface Category
    {
        /**
         * The name of the <b>static field</b> in the {@link com.jagrosh.jmusicbot.jdautils.annotation.JDACommand.Category#location()
