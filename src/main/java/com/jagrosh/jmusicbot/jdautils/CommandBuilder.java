...
/**
 * A chain-setter based builder for {@link com.jagrosh.jmusicbot.jdautils.Command Commands}.
 *
 * <p>This is more useful for creation of commands "mid-runtime". <br>
 * A good usage would be to create a Command via eval and register it via {@link
 * com.jagrosh.jmusicbot.jdautils.CommandClient#addCommand(Command)
...
public class CommandBuilder {
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#name name} of the Command built from
   * this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#help help} snippet of the Command built
  ...
  public CommandBuilder setHelp(String help) {
    if (help == null) this.help = "no help available";
    else this.help = help;
    return this;
  }

  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#category category} of the Command built
   * from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#arguments arguments} of the Command
  ...
  /**
   * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#guildOnly guild
   * only}.
   *
  ...
  /**
   * Sets the name of a {@link com.jagrosh.jmusicbot.jdautils.Command#requiredRole required role} to
   * use the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#ownerCommand owner
   * only}.
   *
   * @param ownerCommand {@code true} if the Command built is owner only, {@code false} if it is
   *     not.
   * @return This CommandBuilder
   */
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#cooldown cooldown} of the Command built
   * from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#userPermissions required user
   * permissions} of the Command built from this CommandBuilder.
   *
   * @param userPermissions The required Permissions a User must have when using the Command to be
   *     built.
   * @return This CommandBuilder
   */
  public CommandBuilder setUserPermissions(Permission... userPermissions) {
    ...
    else this.userPermissions = userPermissions;
    return this;
  }
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#botPermissions required bot permissions}
   * of the Command built from this CommandBuilder.
   *
   * @param botPermissions The required Permissions the bot must have when using the Command to be
   *     built.
   * @return This CommandBuilder
   */
  public CommandBuilder setBotPermissions(Permission... botPermissions) {
    ...
    else this.botPermissions = botPermissions;
    return this;
  }
  ...
  /**
   * Adds a {@link com.jagrosh.jmusicbot.jdautils.Command#aliases alias} for the Command built from
   * this CommandBuilder.
   *
  ...
  /**
   * Adds {@link com.jagrosh.jmusicbot.jdautils.Command#aliases aliases} for the Command built from
   * this CommandBuilder.
   *
  ...
  public CommandBuilder addAliases(String... aliases) {
    for (String alias : aliases) addAlias(alias);
    return this;
  }

  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#aliases aliases} of the Command built
   * from this CommandBuilder.
   *
  ...
  /**
   * Adds a {@link com.jagrosh.jmusicbot.jdautils.Command#children child} Command to the Command
   * built from this CommandBuilder.
   *
  ...
  /**
   * Adds {@link com.jagrosh.jmusicbot.jdautils.Command#children child} Commands to the Command
   * built from this CommandBuilder.
   *
  ...
  public CommandBuilder addChildren(Command... children) {
    for (Command child : children) addChild(child);
    return this;
  }

  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#children children} of the Command built
   * from this CommandBuilder.
   *
  ...
  public CommandBuilder setChildren(Command... children) {
    this.children.clear();
    if (children != null) for (Command child : children) addChild(child);
    return this;
  }
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#helpBiConsumer help BiConsumer} of the
  ...
  /**
   * Sets the Command built to {@link com.jagrosh.jmusicbot.jdautils.Command#usesTopicTags use
   * TopicTags}.
   *
   * @param usesTopicTags {@code true} if the Command built is uses topic tags, {@code false} if it
   *     does not.
   * @return This CommandBuilder
   */
  ...
  /**
   * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#cooldownScope cooldown scope} of the
   * Command built from this CommandBuilder.
   *
  ...
  public CommandBuilder setCooldownScope(Command.CooldownScope cooldownScope) {
    if (cooldownScope == null) this.cooldownScope = Command.CooldownScope.USER;
    else this.cooldownScope = cooldownScope;
    return this;
  }

  /**
   * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#hidden hidden} from
   * the help builder.
   *
   * @param hidden {@code true} if this will be hidden from the help builder, {@code false}
   *     otherwise.
   * @return This CommandBuilder
   */
  ...
  /**
   * Builds the {@link com.jagrosh.jmusicbot.jdautils.Command Command} using the previously provided
   * information.
   *
   * <p>This uses the only the {@link com.jagrosh.jmusicbot.jdautils.CommandEvent CommandEvent}
   * parameter that would be provided during {@link
   * com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent) #execute(CommandEvent)}, and no
   * information about the Command can be retrieved using this.
   *
   * <p>An alternate method {@link
   * com.jagrosh.jmusicbot.jdautils.CommandBuilder#build(java.util.function.BiConsumer)} exists if
   ...
   * information.
   *
   * <p>This uses the both the {@link com.jagrosh.jmusicbot.jdautils.CommandEvent CommandEvent}
   * parameter that would be provided during {@link
   * com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent) #execute(CommandEvent)}, and the
   * Command built when, allowing info on the Command to be retrieved during execution.
   *
   * @param execution The {@link java.util.function.BiConsumer} that runs on {@link
   *     com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent)}.
   * @return The Command built
   */
