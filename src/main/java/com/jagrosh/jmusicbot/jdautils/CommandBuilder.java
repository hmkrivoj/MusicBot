 ...
 * {@link com.jagrosh.jmusicbot.jdautils.CommandClient#addCommand(Command)
...
public class CommandBuilder
{
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#name name}
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#help help}
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#category category}
     * of the Command built from this CommandBuilder.
     *
     * @param  category
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#arguments arguments}
     * of the Command built from this CommandBuilder.
     *
     * @param  arguments
    ...
    /**
     * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#guildOnly
     * guild only}.
     *
     * @param  guildOnly
    ...
    /**
     * Sets the name of a {@link com.jagrosh.jmusicbot.jdautils.Command#requiredRole
    ...
    /**
     * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#ownerCommand
     * owner only}.
     *
     * @param  ownerCommand
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#cooldown cooldown}
     * of the Command built from this CommandBuilder.
     *
     * @param  cooldown
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#userPermissions
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#botPermissions
    ...
    /**
     * Adds a {@link com.jagrosh.jmusicbot.jdautils.Command#aliases alias}
    ...
    /**
     * Adds {@link com.jagrosh.jmusicbot.jdautils.Command#aliases aliases}
     * for the Command built from this CommandBuilder.
     *
     * @param  aliases
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#aliases aliases}
     * of the Command built from this CommandBuilder.
     *
     * @param  aliases
    ...
    /**
     * Adds a {@link com.jagrosh.jmusicbot.jdautils.Command#children child}
    ...
    /**
     * Adds {@link com.jagrosh.jmusicbot.jdautils.Command#children child}
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#children children}
     * of the Command built from this CommandBuilder.
     *
     * @param  children
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#helpBiConsumer
    ...
    /**
     * Sets the Command built to {@link com.jagrosh.jmusicbot.jdautils.Command#usesTopicTags
     * use TopicTags}.
     *
     * @param  usesTopicTags
    ...
    /**
     * Sets the {@link com.jagrosh.jmusicbot.jdautils.Command#cooldownScope
    ...
    /**
     * Sets the Command built to be {@link com.jagrosh.jmusicbot.jdautils.Command#hidden hidden}
    ...
    /**
     * Builds the {@link com.jagrosh.jmusicbot.jdautils.Command Command}
     * using the previously provided information.
     *
     * <p>This uses the only the {@link com.jagrosh.jmusicbot.jdautils.CommandEvent
     * CommandEvent} parameter that would be provided during
     * {@link com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent) #execute(CommandEvent)},
     * and no information about the Command can be retrieved using this.
     *
     * <p>An alternate method {@link com.jagrosh.jmusicbot.jdautils.CommandBuilder#build(java.util.function.BiConsumer)} exists if you wish to retrieve information
     ...
     * using the previously provided information.
     *
     * <p>This uses the both the {@link com.jagrosh.jmusicbot.jdautils.CommandEvent
     * CommandEvent} parameter that would be provided during
     * {@link com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent) #execute(CommandEvent)},
     * and the Command built when, allowing info on the Command to be retrieved during execution.
     *
     * @param  execution
     *         The {@link java.util.function.BiConsumer} that runs on  {@link com.jagrosh.jmusicbot.jdautils.Command#execute(CommandEvent)}.
     *
     * @return The Command built
     */
