...
import com.jagrosh.jmusicbot.jdautils.utils.Paginator;
  ...
  public void doCommand(CommandEvent event) {
    ...
    if (list.isEmpty()) {
      ...
      event.reply(
          built,
          m -> {
            if (nowp != null) bot.getNowplayingHandler().setLastNPMessage(m);
          });
      return;
    }
  ...
  private String getQueueTitle(
    ...
    return FormatUtil.filter(
        sb.append(success)
            ...
            .append(songslength)
            .append(" entries | `")
            .append(TimeUtil.formatTime(total))
            .append("` ")
            .append("| ")
            .append(queueType.getEmoji())
            .append(" `")
            .append(queueType.getUserFriendlyName())
            .append('`')
